...
def score():
    ...
    with st.container():
        ...
        person_income = st.number_input("Ingreso Personal anual (valores en USD)", min_value=0)
        ...
        person_emp_length = st.number_input("Experiencia Laboral (en años)", min_value=0,max_value=100)
        # Lista desplegable con etiquetas comprensibles
        ...
        cb_person_cred_hist_length = st.number_input("Historial credicticio (en años)", min_value=0, max_value=100)
